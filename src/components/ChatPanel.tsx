        ...
        if (attachedFiles.length > 0) {
            ...
            for (const f of attachedFiles) {
                if (f.type.startsWith('image/')) {
                    fileSections.push(`[Attached image: ${f.name} (${f.type}, ${formatFileSize(f.size)}) ΓÇö base64 data available for vision models]`);
                } else {
                ...
                <div className="flex items-center justify-between px-4 pb-3 pt-2 border-t border-[hsl(var(--surface-sunk))]/40">
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            title={chatMode ? 'Chat mode ON ΓÇö conversational, no code gen' : 'Chat mode OFF ΓÇö generates code'}
                        >
